                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.store')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{old('mota')}}" name="mota" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả ">
                            <div class="mb-3">
                            ...
                            <button type="submit" name "them danh muc" class="btn btn-primary">Thêm</button>
                    </form>
                </div>
            </div>
        </div>
